...
public class EvalAdminController {
    ...
    public List<EvalDatasetResponse> listDatasets(@RequestParam Map<String, String> params) {
        return evalService.listDatasets(AdminListQuery.from(params));
    }
    ...
    public List<EvalCaseResponse> listCases(@PathVariable Long id, @RequestParam Map<String, String> params) {
        return evalService.listCases(id, AdminListQuery.from(params));
    }
    ...
    public List<EvalResultResponse> listResults(@PathVariable Long id, @RequestParam Map<String, String> params) {
        return evalService.listResults(id, AdminListQuery.from(params));
    }
}
