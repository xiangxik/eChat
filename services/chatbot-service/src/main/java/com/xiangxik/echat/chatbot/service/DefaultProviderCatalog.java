...
public final class DefaultProviderCatalog {
    ...
    private static final List<ProviderSeed> PROVIDERS = List.of(
            new ProviderSeed("Minimax Overseas", ProviderType.ANTHROPIC, "https://api.minimax.io/anthropic/v1"),
            ...
            new ProviderSeed("Anthropic", ProviderType.ANTHROPIC, "https://api.anthropic.com/v1"),
